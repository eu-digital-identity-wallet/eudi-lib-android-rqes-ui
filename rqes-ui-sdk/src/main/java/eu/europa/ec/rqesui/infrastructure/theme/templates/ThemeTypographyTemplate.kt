...
package eu.europa.ec.rqesui.infrastructure.theme.templates
...
import eu.europa.ec.rqesui.infrastructure.theme.templates.ThemeTextStyle.Companion.toTextStyle
import eu.europa.ec.rqesui.infrastructure.theme.templates.structures.ThemeFont
import eu.europa.ec.rqesui.infrastructure.theme.templates.structures.ThemeFont.Companion.toFont
import eu.europa.ec.rqesui.infrastructure.theme.templates.structures.ThemeFontStyle
import eu.europa.ec.rqesui.infrastructure.theme.templates.structures.ThemeFontStyle.Companion.toFontStyle
import eu.europa.ec.rqesui.infrastructure.theme.templates.structures.ThemeFontWeight
import eu.europa.ec.rqesui.infrastructure.theme.templates.structures.ThemeFontWeight.Companion.toFontWeight
import eu.europa.ec.rqesui.infrastructure.theme.templates.structures.ThemeTextAlign
import eu.europa.ec.rqesui.infrastructure.theme.templates.structures.ThemeTextAlign.Companion.toTextAlign
import eu.europa.ec.rqesui.infrastructure.theme.templates.structures.ThemeTextDecoration
import eu.europa.ec.rqesui.infrastructure.theme.templates.structures.ThemeTextDecoration.Companion.toTextDecoration

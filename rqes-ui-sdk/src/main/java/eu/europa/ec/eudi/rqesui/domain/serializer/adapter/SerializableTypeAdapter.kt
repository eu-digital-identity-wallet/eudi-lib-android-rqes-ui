...
package eu.europa.ec.eudi.rqesui.domain.serializer.adapter
...
internal interface SerializableAdapterType

internal class SerializableTypeAdapter<T : Any> : JsonSerializer<T>, JsonDeserializer<T>,

...
package eu.europa.ec.eudi.rqesui.infrastructure.theme.values
...
import eu.europa.ec.eudi.rqesui.infrastructure.theme.templates.ThemeColorsTemplate
...
internal class ThemeColors {
    companion object {
        ...
        private const val EudiRQESUi_theme_dark_primary: Long = 0xFFD0BCFE
        private const val EudiRQESUi_theme_dark_onPrimary: Long = 0xFF381E72
        private const val EudiRQESUi_theme_dark_primaryContainer: Long = 0xFF4F378B
        private const val EudiRQESUi_theme_dark_onPrimaryContainer: Long = 0xFFEADDFF
        private const val EudiRQESUi_theme_dark_secondary: Long = 0xFFCCC2DC
        private const val EudiRQESUi_theme_dark_onSecondary: Long = 0xFF332D41
        private const val EudiRQESUi_theme_dark_secondaryContainer: Long = 0xFF4A4458
        private const val EudiRQESUi_theme_dark_onSecondaryContainer: Long = 0xFFE8DEF8
        private const val EudiRQESUi_theme_dark_tertiary: Long = 0xFFE8DEF8
        private const val EudiRQESUi_theme_dark_onTertiary: Long = 0xFF492532
        private const val EudiRQESUi_theme_dark_tertiaryContainer: Long = 0xFF633B48
        private const val EudiRQESUi_theme_dark_onTertiaryContainer: Long = 0xFFFFD8E4
        private const val EudiRQESUi_theme_dark_error: Long = 0xFFF2B8B5
        private const val EudiRQESUi_theme_dark_onError: Long = 0xFF601410
        private const val EudiRQESUi_theme_dark_errorContainer: Long = 0xFF8C1D18
        private const val EudiRQESUi_theme_dark_onErrorContainer: Long = 0xFFF9DEDC
        private const val EudiRQESUi_theme_dark_surface: Long = 0xFF141218
        private const val EudiRQESUi_theme_dark_onSurface: Long = 0xFFE6E0E9
        ...
        private const val EudiRQESUi_theme_dark_onSurfaceVariant: Long = 0xFFCAC4D0
        private const val EudiRQESUi_theme_dark_outline: Long = 0xFF938F99
        private const val EudiRQESUi_theme_dark_outlineVariant: Long = 0xFF49454F
        private const val EudiRQESUi_theme_dark_scrim: Long = black
        private const val EudiRQESUi_theme_dark_inverseSurface: Long = 0xFFE6E0E9
        private const val EudiRQESUi_theme_dark_inverseOnSurface: Long = 0xFF322F35
        private const val EudiRQESUi_theme_dark_inversePrimary: Long = 0xFF6750A4
        private const val EudiRQESUi_theme_dark_surfaceDim: Long = 0xFF141218
        private const val EudiRQESUi_theme_dark_surfaceBright: Long = 0xFF3B383E
        private const val EudiRQESUi_theme_dark_surfaceContainerLowest: Long = 0xFF0F0D13
        private const val EudiRQESUi_theme_dark_surfaceContainerLow: Long = 0xFF1D1B20
        private const val EudiRQESUi_theme_dark_surfaceContainer: Long = 0xFF211F26
        private const val EudiRQESUi_theme_dark_surfaceContainerHigh: Long = 0xFF2B2930
        private const val EudiRQESUi_theme_dark_surfaceContainerHighest: Long = 0xFF36343B
